...
{
    public partial class VerRegistosTerapeuta : Form
    {
        Connections ligacao = new Connections();
        public VerRegistosTerapeuta()
        {
            InitializeComponent();
        }
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione um paciente para consultar.");
                cbPacientes.Focus();
            }
        ...
        private void PreencherListaCrise(DateTime dataInicio, DateTime dataFim)
        {
            ...
            string[] texto = cbPacientes.Text.Split(new Char[] { '-' });
            string idPaciente = texto[0];
        ...
        private void VerRegistosTerapeuta_Load(object sender, EventArgs e)
        {
        ...
        private bool ListarPaciente()
        {
            ...
            string queryPacientes = $@"
                SELECT pacientes.idPaciente, pacientes.nome FROM pacientes
	                WHERE pacientes.idTerapeuta = {idUtilizador}";

            try
            {
                SQLiteCommand cmd = new SQLiteCommand(queryPacientes, ligacao.OpenConnection());
                SQLiteDataReader dataReader = cmd.ExecuteReader();
